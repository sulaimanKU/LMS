...
<head>
    ...
    <title>Forgot Password — {{ $systemSettings['site_title'] ?? 'MyLMS' }}</title>
    ...
    <div class="main-auth-container">
        ...
        <div class="brand-side">
            ...
            <div class="brand-main">
                ...
                <p>Enter your account email address below and we will dispatch a secure password reset link to your inbox.</p>
            </div>
        ...
        <div class="form-side">
            ...
            <div class="form-intro">
                ...
                <p>Don't worry! Enter your email to receive reset instructions.</p>
            </div>
